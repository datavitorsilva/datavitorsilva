...
# 👋 Olá, eu sou Vitor Manuel

### `Estagiário em Dados` • `Analista de Dados` • `Engenharia de Dados` • `Engenharia de Software`

<img src="./assets/vitor-coding.gif" width="900" alt="Vitor programando">

<br>

📊 Dados • 💻 Backend • 🗄️ Banco de Dados • 📈 BI • ⚙️ APIs
...
Sou estudante de **Engenharia de Software**, com foco em **Dados, Backend, APIs e Banco de Dados**.
Tenho estudado e desenvolvido projetos utilizando Python, SQL, Java, JavaScript e ferramentas do ecossistema de desenvolvimento de software.
Tenho interesse em transformar dados e requisitos em soluções organizadas, funcionais e fáceis de manter.

🎓 **Bacharelado em Engenharia de Software — Anhanguera**
📅 Formação prevista: **2028**
📍 São Paulo, Brasil
...
### 🗄️ Dados, Backend e Banco de Dados
...
API REST desenvolvida para gerenciamento e análise de informações de funcionários.

**Tecnologias:** Python • FastAPI • SQLAlchemy • MySQL • Docker
